<?php
    if(isset($_POST['submit'])) {
        ...
        $query = "DELETE FROM `hospital` WHERE hos_id='$hid'";
...
<html>
    ...
    <body class="text-center">
        ...
        <h4 class="del-head">Hospital Ids With Corresponding Hospital Names</h4>
            ...
            <div class="row text-center">
                <div class="form">
                    <form class="login-form" method="post" action="del-hos.php">
                        <label for="id">Hospital ID : 
                            <select style="padding: 3px 9px; margin-left: 21px;" name="hid" required>
                                <option value="" disabled selected hidden>Select Hospital ID to be deleted</option>
                                <?php
                                    include('../dbconnection.php');
                                    $query = "SELECT * FROM `hospital`";
                                    $run = mysqli_query($conn,$query);
                        ...
                        <!-- <input id="id" type="text" placeholder="Enter Hospital ID to be deleted" name="hid" required> -->
                        </label><br>
