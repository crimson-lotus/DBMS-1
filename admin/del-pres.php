<?php
    if(isset($_POST['submit'])) {
        ...
        $query = "DELETE FROM `prescription` WHERE pres_id='$preid'";
...
<html>
    ...
    <body class="text-center">
        ...
        <h4 class="del-head">Prescription Ids With their Corresponding Medicine's</h4>
            ...
            <div class="row text-center">
                <div class="form">
                    <form class="login-form" method="post" action="del-pres.php">
                        <label for="id">Prescription ID : 
                            <select style="padding: 3px 9px; margin-left: 15px;" name="preid" required>
                                <option value="" disabled selected hidden>Select Prescription ID to be deleted</option>
                                <?php
                                    include('../dbconnection.php');
                                    $query = "SELECT * FROM `prescription`";
                                    $run = mysqli_query($conn,$query);
                        ...
                        <!-- <input id="id" type="text" placeholder="Enter Prescription ID to be deleted" name="preid" required> -->
                        </label><br>
